...
// or registration/news policy values should import them from here instead
// of reading process.env directly.
//
// To rename the bot, change its prefix, or retarget policies: change the
// value in .env — nothing in this file, or in any file that imports from
// it, needs to change.
//
...
// behave as expected once deployed, this is the one value to adjust.
